...
$producto = $control->buscar_producto($id);
                    ...
                    <form action="update.php" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="idproducto_display" class="form-label">ID Producto</label>
                                <input type="text" class="form-control" id="idproducto_display" value="<?= $producto['idproducto'] ?>" readonly>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="nombre" class="form-label">Nombre del Producto *</label>
                                <input type="text" class="form-control" name="nombre" id="nombre" value="<?= htmlspecialchars($producto['nomproducto']) ?>" required maxlength="128">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="unimed" id="unimed" value="<?= htmlspecialchars($producto['unimed']) ?>" maxlength="32">
                            </div>
                            <div class="col-md-6 mb-3">
